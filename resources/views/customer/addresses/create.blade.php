<x-layouts.app title="ঠিকানা যোগ করুন">
            ...
            <div class="col-lg-9">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h1 class="h4 mb-4">নতুন ঠিকানা যোগ করুন</h1>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="label" name="label"
                                           ...
                                           value="{{ old('label') }}" placeholder="বাসা, অফিস ইত্যাদি">
                                    @error('label')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="type" name="type"
                                        ...
                                        <option value="shipping" {{ old('type') === 'shipping' ? 'selected' : '' }}>শিপিং</option>
                                        <option value="billing" {{ old('type') === 'billing' ? 'selected' : '' }}>বিলিং</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="country" name="country"
                                           ...
                                           value="{{ old('country', 'Bangladesh') }}" required>
                                    @error('country')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-success">ঠিকানা সংরক্ষণ করুন</button>
